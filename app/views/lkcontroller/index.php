        ...
        <div class="col-11">
            ...
            <form id="reg_form" action="" method="post">
               <div class="mb-0">
                    ...
                    <input type="text" class="form-control" id="name" name="name" value="<?= $_SESSION["USER_NAME"] ?>" required="true" >
                </div>
                <div class="mb-0">
                    <label for="sname" class="form-label">Фамилия</label>
                    <input type="sname" class="form-control" id="sname" name="sname" value="<?= $_SESSION["USER_SNAME"] ?>" required="true" >
                </div>
                <div class="mb-0">
                    <label for="login" class="form-label">Логин</label>
                    <input type="text" class="form-control" id="login" name="login" value="<?= $_SESSION["USER_LOGIN"] ?>" required="true" >
                </div>
                <div class="mb-0">
                    <label for="email" class="form-label">Емайл</label>
                    <input type="email" class="form-control" id="email" name="email" value="<?= $_SESSION["USER_EMAIL"] ?>" required="true" >
                </div>
                <div class="mb-0">
                    <label for="phone" class="form-label">Телефон</label>
                    <input type="phone" class="form-control" id="phone" name="phone" value="<?= $_SESSION["USER_PHONE"] ?>" required="true" >
                </div>
